<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    ...
    Title="แสดงข้อมูลสัญญาการยืมเงิน" %>
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            <td style="text-align: right; width: 150px;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage18">สถานะสัญญา : </asp:Label>
            </td>
            <td style="text-align: left; white-space: nowrap;">
                <asp:DropDownList runat="server" CssClass="textbox" ID="cboLoanStatus">
                    ...
                    <asp:ListItem Value="S">ชำระคืนบางส่วน</asp:ListItem>
                    <asp:ListItem Value="F">ชำระคืนหมดแล้ว</asp:ListItem>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="เลขที่สัญญา" SortExpression="loan_doc">
            ...
            <asp:TemplateField HeaderText="รายการสัญญาการยืมเงิน" SortExpression="loan_title"
                Visible="true">
             ...
             <asp:TemplateField HeaderText="จำนวนเงินขอยืม" SortExpression="loan_approve" Visible="true">
            ...
            <asp:TemplateField HeaderText="การขออนุมัติเบิก" Visible="true">
            ...
            <asp:TemplateField HeaderText="ผู้สัญญาการยืมเงิน" SortExpression="person_thai_name"
                Visible="true">
            ...
            <asp:TemplateField HeaderText="คณะ/สังกัด (หน่วยงาน)" SortExpression="director_name" Visible="false">
                <ItemStyle HorizontalAlign="Left" Wrap="True" Width="15%"></ItemStyle>
                <ItemTemplate>
