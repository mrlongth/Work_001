                        ...
                        <ContentTemplate>
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%;">
                                ...
                                <tr align="left">
                                    ...
                                    <td nowrap style="text-align: right">
                                        <asp:Label ID="Label54" runat="server" CssClass="label_h">แผนงบ :</asp:Label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr align="left">
                                    <td align="right" nowrap valign="middle">
                                        <asp:Label ID="Label55" runat="server" CssClass="label_h">รายการ :</asp:Label>
                                    </td>
                                    <td align="left" nowrap valign="middle">
                                ...
                                <tr align="left">
                                    <td align="right" nowrap valign="middle">
                                        <asp:Label ID="Label56" runat="server" CssClass="label_h">แผนงาน :</asp:Label>
                                    </td>
                                    <td align="left" nowrap valign="middle">
