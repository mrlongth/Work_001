...
namespace myWeb.App_Control.reportsparameter
{
    ...
    public partial class payment_back_report_income_show : PageBase
    {
        ...
        private void printData()
        {
            ...
            else if (ViewState["report_code"].ToString().Equals("Rep_paymentincomeSOS"))
            {
                Retive_Rep_paymentSOS();
            }
            else if (ViewState["report_code"].ToString().Equals("Rep_paymentincomeSOS_sum"))
            {
        ...
        private void getQueryString()
        {
            ...
            if (!ViewState["report_id"].Equals("0"))
            {
                ...
                if (oPayment_back.SP_PAYMENT_BACK_REPORT_SEL(strCriteria2, ref ds, ref strMessage))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ViewState["report_code"] = dt.Rows[0]["report_code"].ToString().Replace("Rep_paymentSOS", "Rep_paymentincomeSOS");
                        ...
                        ViewState["report_code"] = ViewState["report_code"].ToString().Replace("Rep_paymentSOS", "Rep_paymentincomeSOS");
