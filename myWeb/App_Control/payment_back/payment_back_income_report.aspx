<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="payment_back_income_report.aspx.cs" Inherits="myWeb.App_Control.payment_back.payment_back_income_report"
        ...
        <tr>
            ...
            <td style="text-align: right; width: 70%; vertical-align: top;">
                <table cellpadding="1" cellspacing="1" style="width: 100%;" border="0">
                    ...
                    <tr>
                        <td style="text-align: right; width: 20%;">
                            <asp:Label runat="server" ID="Label15" CssClass="label_h">รายการ :</asp:Label>
                        </td>
                        <td style="width: 1%; text-align: left;">
                            <font face="Tahoma">
                    ...
                    <tr>
                        <td style="text-align: right; width: 20%;">
                            <asp:Label runat="server" CssClass="label_h" ID="lblPage7x">กิจกรรม :
                            </asp:Label>
                        </td>
                        <td style="width: 1%; text-align: left;" colspan="3">
                            <asp:DropDownList runat="server" CssClass="textbox" ID="cboActivity">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:DropDownList ID="cboWork" runat="server" CssClass="textbox">
                    ...
                    <tr>
                        <td style="width: 20%; text-align: right;">
                            <asp:Label runat="server" CssClass="label_h" ID="lblPage8">หน่วยงาน/สาขา :
                            </asp:Label>
                        </td>
                        <td style="width: 1%; text-align: left;" colspan="3">
